export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Odybench",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Odybench has been downloaded, would you like to install it and relaunch?",
