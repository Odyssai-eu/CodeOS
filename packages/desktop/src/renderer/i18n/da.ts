export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Odybench",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Odybench er blevet downloadet. Vil du installere den og genstarte?",
