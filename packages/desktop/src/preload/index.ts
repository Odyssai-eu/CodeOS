...
const api: ElectronAPI = {
  ...
  getJudgeModel: () => ipcRenderer.invoke("get-judge-model"),
  setJudgeModel: (modelID) => ipcRenderer.invoke("set-judge-model", modelID),
  getCoeosProvider: () => ipcRenderer.invoke("get-coeos-provider"),
  setCoeosProvider: (text) => ipcRenderer.invoke("set-coeos-provider", text),
