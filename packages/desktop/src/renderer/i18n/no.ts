export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Odybench",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Odybench er lastet ned. Vil du installere den og starte på nytt?",
