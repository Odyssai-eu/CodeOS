      ...
      <div class="settings-v2-section">
        ...
        <SettingsListV2>
          ...
          <Show when={desktop() && platform.getYolo}>
            <SettingsRowV2
              title="Mode YOLO"
              description="Accepte TOUTES les permissions sans jamais demander — y compris les gestes destructifs (rm -rf, push --force, reset --hard). Aucun filet. À tes risques. Redémarre coeos-code pour appliquer."
            >
