export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Odybench",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Odybench wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
