export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Odybench-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Odybench-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
