export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Odybench",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Odybench. ¿Quieres instalarla y reiniciar?",
