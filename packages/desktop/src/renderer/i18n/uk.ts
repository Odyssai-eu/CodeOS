export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію Odybench",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} Odybench завантажено. Бажаєте встановити її та перезапустити?",
