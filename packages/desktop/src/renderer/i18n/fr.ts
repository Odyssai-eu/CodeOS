export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Odybench",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Odybench a été téléchargée. Voulez-vous l'installer et redémarrer ?",
