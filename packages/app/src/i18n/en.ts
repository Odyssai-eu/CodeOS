export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Odybench",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Odybench.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Odybench.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Odybench.",
  ...
  "dialog.server.description": "Switch which Odybench server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Odybench",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Odybench...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Odybench in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Odybench...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Odybench in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Odybench in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Odybench",
  "wsl.onboarding.opencodeReadyIn": "Odybench is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Odybench is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Odybench in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Odybench",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Odybench not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Odybench can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Odybench could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Odybench.",
  ...
  "toast.update.description": "A new version of Odybench ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Odybench team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Odybench does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Odybench includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Odybench server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Odybench",
  ...
  "settings.general.row.appearance.description": "Customise how Odybench looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Odybench follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Odybench is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Odybench launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Odybench.",
