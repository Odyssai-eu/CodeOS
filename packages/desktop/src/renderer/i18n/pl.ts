export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Odybench",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Odybench. Czy chcesz ją zainstalować i uruchomić ponownie?",
