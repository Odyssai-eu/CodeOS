...
const createPlatform = (windowState: DesktopWindowState): Platform => {
  ...
  return {
    ...
    getJudgeModel: () => window.api.getJudgeModel(),

    setJudgeModel: (modelID: string) => window.api.setJudgeModel(modelID),

    getCoeosProvider: () => window.api.getCoeosProvider(),

    setCoeosProvider: (text: string) => window.api.setCoeosProvider(text),
